...
knitr::include_graphics("https://github.com/organx/RepData_PeerAssessment1/blob/master/images/plot1.png")

```
! [] (https://github.com/organx/RepData_PeerAssessment1/blob/master/images/plot1.png)
